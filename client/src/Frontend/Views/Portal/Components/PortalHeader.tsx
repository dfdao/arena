...
import { useEthConnection, useSeasonData, useSeasonPlayers } from '../../../Utils/AppHooks';
import { MinimalButton } from '../PortalMainView';
import { populateBulk } from '../../../../Backend/Utils/Populate';
...
export const PortalHeader = () => {
  ...
  const { setPlayers } = useSeasonPlayers();
