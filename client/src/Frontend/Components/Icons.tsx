...
export const Quasar = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/planettypes/quasar.svg' />;
};

export const FoundRuins = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/planettypes/ruins.svg' />;
};
export const Star = ({
  height,
  width,
  color,
  index,
}: AlertIcon & { color: string } & { index: number | undefined }) => {
  return (
    <img
      key={index && 0}
      height={height}
...
export const Gnosis = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/gclogo.svg' />;
};

export const Twitter = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/twitter.svg' />;
};

export const FoundSpacetimeRip = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/planettypes/tradingpost.svg' />;
};

export const FoundSilver = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/planettypes/asteroid.svg' />;
};
...
export const FoundSpace = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/spacetypes/space.svg' />;
};

export const FoundDeepSpace = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/spacetypes/deepspace.svg' />;
};

export const FoundDeadSpace = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/spacetypes/deadspace.svg' />;
};

export const FoundPirates = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/pirates.svg' />;
};

export const Generic = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/generic/generic.svg' />;
};

export const ArtifactFound = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/artifacts/find.svg' />;
};
export const ArtifactProspected = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/artifacts/prospect.svg' />;
};

export const FoundOcean = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/ocean.svg' />;
};

export const FoundForest = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/forest.svg' />;
};

export const FoundGrassland = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/grassland.svg' />;
};

export const FoundTundra = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/tundra.svg' />;
};

export const FoundSwamp = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/swamp.svg' />;
};

export const FoundDesert = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/desert.svg' />;
};

export const FoundIce = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/ice.svg' />;
};

export const FoundWasteland = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/wasteland.svg' />;
};

export const FoundLava = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/lava.svg' />;
};

export const FoundCorrupted = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/biomes/corrupted.svg' />;
};
export const PlanetAttacked = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/planetattacked.svg' />;
};
export const PlanetSupported = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/planetsupported.svg' />;
};
export const PlanetLost = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/planetlost.svg' />;
};
export const PlanetConquered = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/planetwon.svg' />;
};
export const MetPlayer = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/combat/metplayer.svg' />;
};
export const TxAccepted = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/transactions/accepted.svg' />;
};
export const TxConfirmed = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/transactions/confirmed.svg' />;
};
export const TxInitialized = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/transactions/initialized.svg' />;
};
export const TxDeclined = ({ height, width }: AlertIcon) => {
  return <img height={height} width={width} src='/icons/alerts/transactions/declined.svg' />;
};
