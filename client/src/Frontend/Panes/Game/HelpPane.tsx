    ...
    <ModalPane id={ModalName.Help} title='Help' visible={visible} onClose={onClose}>
      <HelpContent>
        ...
        <Section>
          ...
          <Link newTab to='https://dfwiki.net'>
            official Dark Forest Wiki
          </Link>
        </Section>
        <Section>
          ...
          <Link
            newTab
            to='https://www.notion.so/cha0sg0d/Celestial-Bodies-503bb5dc2ad0443ca22891b07e853e55'
          >
            Celestial Bodies
          </Link>
          <br />
          <Link newTab to='https://www.notion.so/cha0sg0d/Stats-3e8f0bb8b94a4db5bf9829f75ede219c'>
            Planet Stats
          </Link>
          <br />
          <Link
            newTab
            to='https://www.notion.so/cha0sg0d/Space-Types-4a9db79416fa4cae9c5a1a62f107f053'
          >
            Space Types
          </Link>
          <br />
          <Link
            newTab
            to='https://www.notion.so/cha0sg0d/Artifacts-c35916760c244cf1ba7e37a3d2003eb3'
          >
            Artifacts
          </Link>
          <br />
          <Link
            newTab
            to='https://www.notion.so/cha0sg0d/Spaceships-d913314f917d42b0afe28a9b09148689'
          >
            Spaceships
          </Link>
          <br />
        ...
        <Section>
          ...
          <Link
            newTab
            to='https://medium.com/@classicjdf/classicjs-dark-forest-beginners-guide-part2-defense-ff0fd2fd442e'
          >
            Part 2: Defense
          </Link>
          <br />
          <Link
            newTab
            to='https://medium.com/@classicjdf/classicjs-dark-forest-beginners-guide-part-3-range-c2f63d7a7ac0'
          >
            Part 3: Range
          </Link>
          <br />
          <Link
            newTab
            to='https://medium.com/@classicjdf/classicjs-dark-forest-beginners-guide-part-4-speed-b17b8d3d85d5'
          >
            Part 4: Speed
          </Link>
          <br />
